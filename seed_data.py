...
def seed_database():
        ...
        sample_reviews = [
            {
                ...
                "rating": 5,
                "title": "Exceptional Quality! Flipkart delivery was super fast.",
            ...
            },
            {
                ...
                "rating": 5,
                "title": "Awesome! Flipkart Assured promise kept.",
    ...
    conn.commit()
    conn.close()
    print("Database seeded with sample Flipkart categories, products, reviews & orders!")
